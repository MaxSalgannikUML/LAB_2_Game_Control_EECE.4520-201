...
while True:
    ...
    # elif ......
    #
    read = ser.readline() #reads the serial port
    control_information = read.decode('utf-8') #converts the info from the serial port into text
    print(control_information) #prints the information for up, down, left, and right by reading if the input is wasd
    if control_information == 'w':
